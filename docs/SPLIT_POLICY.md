...
本文件定义本项目 benchmark 切分规则，用于保证评测可比较、可追踪，并降低“同源格式泄漏”。

注意：正式 benchmark 的 split 政策必须在本文件基础上冻结，并配套 `results/benchmarks/split_audit.tsv`、污染检查与双标裁决流程。
