...
REQUIRED_PATHS = [
    ...
    "data/benchmarks/field_hardcase_labels_public_v1.tsv",
    "data/benchmarks/entry_segmentation_gold_index_v1.tsv",
    "data/benchmarks/entry_segmentation_dual_labels_v1.tsv",
    "data/benchmarks/document_type_dual_labels_v1.tsv",
    ...
    "results/error_analysis/error_slices_models_v3_dual.tsv",
    "results/error_analysis/boundary_silver_error_slices.tsv",
    "results/benchmarks/field_value_eval.tsv",
    "results/benchmarks/field_value_item_outcomes_v1.tsv",
    "results/benchmarks/field_presence_item_outcomes_v1.tsv",
    "results/benchmarks/boundary_baseline_test_predictions_v2.tsv",
    "results/benchmarks/boundary_baseline_test_summary_v2.tsv",
    "results/statistics/boundary_baseline_mcnemar_v2.tsv",
    "results/metadata/boundary_baseline_eval_v2.json",
    "results/corpus/parse_summary_v14.json",
    ...
    "results/manuscript/source_data19_field_consistency_flags.tsv",
    "results/iaa/entry_segmentation_iaa_v4.tsv",
