...
Versioned GitHub releases are archived on Zenodo. Release `v1.0.8` is the current derived-only package (version DOI: `https://doi.org/10.5281/zenodo.22734516`); the concept DOI `https://doi.org/10.5281/zenodo.20376555` resolves to the latest archived version.
